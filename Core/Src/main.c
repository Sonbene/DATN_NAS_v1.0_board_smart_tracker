...
void HAL_SPI_TxRxCpltCallback(SPI_HandleTypeDef *hspi)
{
    if (hspi->Instance == SPI1) {
        BSP_SPI_TxRxCpltCallback((BSP_SPI_Handle_t *)spi1_bus.active_handle);
    }
}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : PA4 PA6 PA7 PA12 */
  GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void StartDefaultTask(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  // Sau khi xong việc thì TỰ HỦY (Terminate) task này và thoát
