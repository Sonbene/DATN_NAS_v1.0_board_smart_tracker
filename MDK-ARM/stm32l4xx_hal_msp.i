#line 1 "../Core/Src/stm32l4xx_hal_msp.c"
...
#line 23 "../Core/Src/stm32l4xx_hal_msp.c"
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL)))
  {
    ...
    PeriphClkInit.PeriphClockSelection = 0x00004000U;
    PeriphClkInit.AdcClockSelection = (0x1UL << (28U));
    PeriphClkInit.PLLSAI1.PLLSAI1Source = (0x3UL << (0U));
    PeriphClkInit.PLLSAI1.PLLSAI1M = 1;
    PeriphClkInit.PLLSAI1.PLLSAI1N = 8;
    PeriphClkInit.PLLSAI1.PLLSAI1P = 0x00000007U;
    PeriphClkInit.PLLSAI1.PLLSAI1Q = 0x00000002U;
    PeriphClkInit.PLLSAI1.PLLSAI1R = 0x00000002U;
    PeriphClkInit.PLLSAI1.PLLSAI1ClockOut = (0x1UL << (24U));
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (13U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (13U)))); (void)tmpreg; } while(0);
    ...
    GPIO_InitStruct.Mode = ((0x3uL << 0u) | 0x8uL);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08040000UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) &= ~((0x1UL << (13U))));

    

 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0002));
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) |= ((0x1UL << (12U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) & ((0x1UL << (12U)))); (void)tmpreg; } while(0);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0008)|((uint16_t)0x0010)|((uint16_t)0x0020);
    ...
    hdma_spi1_tx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0030UL));
    hdma_spi1_tx.Init.Request = 1U;
    hdma_spi1_tx.Init.Direction = (0x1UL << (4U));
    hdma_spi1_tx.Init.PeriphInc = 0x00000000U;
    hdma_spi1_tx.Init.MemInc = (0x1UL << (7U));
    hdma_spi1_tx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_spi1_tx.Init.MemDataAlignment = 0x00000000U;
    hdma_spi1_tx.Init.Mode = 0x00000000U;
    hdma_spi1_tx.Init.Priority = 0x00000000U;
    ...
    hdma_spi1_rx.Instance = ((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x001CUL));
    hdma_spi1_rx.Init.Request = 1U;
    hdma_spi1_rx.Init.Direction = 0x00000000U;
    hdma_spi1_rx.Init.PeriphInc = 0x00000000U;
    hdma_spi1_rx.Init.MemInc = (0x1UL << (7U));
    hdma_spi1_rx.Init.PeriphDataAlignment = 0x00000000U;
    hdma_spi1_rx.Init.MemDataAlignment = 0x00000000U;
    hdma_spi1_rx.Init.Mode = 0x00000000U;
    hdma_spi1_rx.Init.Priority = 0x00000000U;
    if (HAL_DMA_Init(&hdma_spi1_rx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (hspi)->hdmarx = &(hdma_spi1_rx); (hdma_spi1_rx). Parent = (hspi); } while(0);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==((SPI_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x3000UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) &= ~((0x1UL << (12U))));
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0008)|((uint16_t)0x0010)|((uint16_t)0x0020));
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x4400UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (17U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (17U)))); (void)tmpreg; } while(0);
  ...
  else if(huart->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x4800UL)))
  {
    ...
    PeriphClkInit.PeriphClockSelection = 0x00000004U;
    PeriphClkInit.Usart3ClockSelection = 0x00000000U;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (18U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (18U)))); (void)tmpreg; } while(0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x4400UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) &= ~((0x1UL << (17U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0004)|((uint16_t)0x0008));
  ...
  else if(huart->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x4800UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) &= ~((0x1UL << (18U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0400)|((uint16_t)0x0800));
