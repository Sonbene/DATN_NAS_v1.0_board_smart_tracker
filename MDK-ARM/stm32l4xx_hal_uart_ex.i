...
HAL_StatusTypeDef HAL_UARTEx_EnableClockStopMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") | ((0x1UL << (23U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
...
#line 1061 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart_ex.c"
