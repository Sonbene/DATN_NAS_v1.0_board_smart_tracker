#line 1 "..\\Lib\\Services\\StorageManager\\storage_manager.c"
...
#line 2 "..\\Lib\\Services\\StorageManager\\storage_manager.c"
...
#line 3 "..\\Lib\\Services\\StorageManager\\storage_manager.c"
...
#line 4 "..\\Lib\\Services\\StorageManager\\storage_manager.c"
...
Storage_Status_t Storage_Recover(W25Q_Handle_t *flash, Storage_Config_t *config, Storage_Context_t *ctx) {
    ...
    Debug_Log("[INFO] " "Storage: Starting recovery for region 0x%08X..." "\r\n",config->start_addr);
...
Storage_Status_t Storage_Append(W25Q_Handle_t *flash, Storage_Config_t *config, Storage_Context_t *ctx, void *data) {
    ...
    if (ctx->current_index >= ctx->total_capacity) {
        Debug_Log("[WARN] " "Storage: Region full! Auto-formatting..." "\r\n");
