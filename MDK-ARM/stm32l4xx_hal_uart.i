...
#line 167 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 191 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"

#line 199 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 254 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 362 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 427 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 513 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 597 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 671 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 1045 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 1381 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
    ...
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (7U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
  ...
  if (huart->RxState == 0x00000020U)
  {
    ...
    if (!(((huart->Instance) == ((USART_TypeDef *) ((0x40000000UL) + 0x8000UL)))))
    {
      ...
      if (((huart->Instance ->CR2) & ((0x1UL << (23U)))) != 0U)
      {
        ...
        do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (26U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
      }
    }
...
HAL_StatusTypeDef HAL_UART_Abort(UART_HandleTypeDef *huart)
{
#line 1724 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 1801 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 1874 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 2091 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 2193 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
      ...
      && ((cr1its & (0x1UL << (4U))) != 0U))
  {
    ...
    else
    {
      ...
      if ((huart->RxXferCount > 0U)
          && (nb_rx_data > 0U))
      {
#line 2576 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 2672 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
}
...
HAL_StatusTypeDef HAL_MultiProcessor_EnableMuteMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (13U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_HalfDuplex_EnableTransmitter(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") & ~(((0x1UL << (3U)) | (0x1UL << (2U)))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);

   
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (3U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_HalfDuplex_EnableReceiver(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (2U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
...
#line 3140 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 3214 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
  ...
  if (((((huart)->Instance) == ((USART_TypeDef *) ((0x40000000UL) + 0x8000UL)))))
  {
    ...
    switch (clocksource)
    {
      ...
      case UART_CLOCKSOURCE_HSI:
        pclk = (uint32_t) ((uint32_t)16000000U);
        break;
      case UART_CLOCKSOURCE_SYSCLK:
        pclk = HAL_RCC_GetSysClockFreq();
        break;
      case UART_CLOCKSOURCE_LSE:
        pclk = (uint32_t) 32768U;
        break;
      default:
        pclk = 0U;
        ret = HAL_ERROR;
    ...
    if (pclk != 0U)
    {
#line 3271 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
      ...
      {
        usartdiv = (uint32_t)((((((uint64_t)(pclk)*256U)) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
  ...
  else if (huart->Init.OverSampling == (0x1UL << (15U)))
  {
    ...
    if (pclk != 0U)
    {
      ...
      usartdiv = (uint32_t)(((((pclk)*2U) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
  ...
  else
  {
    ...
    if (pclk != 0U)
    {
      ...
      usartdiv = (uint32_t)((((pclk) + ((huart->Init . BaudRate)/2U)) / (huart->Init . BaudRate)));
...
#line 3663 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
  ...
  if (huart->Init.Parity != 0x00000000U)
  {
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (8U)) | (0x1UL << (5U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
  }
  else
  {
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (5U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
  }
...
#line 4049 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 4139 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 4339 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
...
#line 4827 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_uart.c"
