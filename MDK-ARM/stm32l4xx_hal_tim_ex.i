...
#line 84 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_tim_ex.c"
...
#line 176 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_tim_ex.c"
...
#line 260 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_tim_ex.c"
                                                        ...
                                                        const TIM_MasterConfigTypeDef *sMasterConfig)
{
  ...
  if (((htim->Instance) == ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x2C00UL))))
  {
...

{
  ...
  ((void)0U);
  ((void)0U);
#line 2128 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_tim_ex.c"
  ((void)0U);
...
#line 2170 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_tim_ex.c"
...
HAL_StatusTypeDef HAL_TIMEx_RemapConfig(TIM_HandleTypeDef *htim, uint32_t Remap)
{
  ...
  if ((((htim->Instance) == ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x2C00UL))) || ((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)))))
  {
    tmpor2 = htim->Instance->OR2;
    tmpor2 &= ~(0x7UL << (14U));
    tmpor2 |= (Remap & (0x7UL << (14U)));
