#line 1 "../Core/Src/stm32l4xx_hal_timebase_tim.c"
...
#line 22 "../Core/Src/stm32l4xx_hal_timebase_tim.c"
#line 23 "../Core/Src/stm32l4xx_hal_timebase_tim.c"
...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x1UL << (5U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) & ((0x1UL << (5U)))); (void)tmpreg; } while(0);
  ...
  if (uwAPB1Prescaler == (0x00000000UL))
  {
  ...
  htim7.Instance = ((TIM_TypeDef *) ((0x40000000UL) + 0x1400UL));
