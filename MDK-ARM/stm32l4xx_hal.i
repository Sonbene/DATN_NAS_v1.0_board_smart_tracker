...
#line 37 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal.c"
...
#line 62 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal.c"
...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24U) |((0x0DU) << 16U) |((0x03U) << 8U) |((0x00U)));
}
...
void HAL_SYSCFG_EnableMemorySwappingBank(void)
{
  *(volatile uint32_t *)((0x42000000UL) + (((((0x40000000UL) + 0x00010000UL) + 0x0000UL) - (0x40000000UL)) * 32U) + (8U * 4U)) = 0x00000001UL;
}
