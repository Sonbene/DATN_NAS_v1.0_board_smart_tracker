...
#line 92 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  if ((uint32_t)(hdma->Instance) < (uint32_t)(((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL))))
  {
    ...
    hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0008UL))) / ((uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x001CUL)) - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL)) + 0x0008UL)))) << 2U;
    hdma->DmaBaseAddress = ((DMA_TypeDef *) (((0x40000000UL) + 0x00020000UL)));
  }
  else
  {
     
    hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL))) / ((uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x001CUL)) - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x0400UL) + 0x0008UL)))) << 2U;
...
#line 248 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
#line 380 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
#line 526 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
#line 592 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
#line 649 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  ...
  {
    if((hdma->DmaBaseAddress->ISR & ((0x1UL << (3U)) << (hdma->ChannelIndex& 0x1CU))) != 0U)
    {
...
#line 778 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if (((flag_it & ((0x1UL << (2U)) << (hdma->ChannelIndex & 0x1CU))) != 0U) && ((source_it & (0x1UL << (2U))) != 0U))
  {
  ...
  else if (((flag_it & ((0x1UL << (1U)) << (hdma->ChannelIndex & 0x1CU))) != 0U) && ((source_it & (0x1UL << (1U))) != 0U))
  {
    if((hdma->Instance->CCR & (0x1UL << (5U))) == 0U)
    {
  ...
  else if (((flag_it & ((0x1UL << (3U)) << (hdma->ChannelIndex & 0x1CU))) != 0U) && ((source_it & (0x1UL << (3U))) !=  0U))
  {
...
static void DMA_SetConfig(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
#line 1081 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
...
#line 1158 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_dma.c"
