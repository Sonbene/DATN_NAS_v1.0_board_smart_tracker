#line 1 "..\\Lib\\Driver_Custom\\w25q32.c"
...
#line 2 "..\\Lib\\Driver_Custom\\w25q32.c"
...
#line 3 "..\\Lib\\Driver_Custom\\w25q32.c"
#line 1 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS/cmsis_os.h"
...
#line 4 "..\\Lib\\Driver_Custom\\w25q32.c"
...
#line 5 "..\\Lib\\Driver_Custom\\w25q32.c"
...
W25Q_Status_t W25Q_Init(W25Q_Handle_t *handle, BSP_SPI_Handle_t *spi_handle, GPIO_TypeDef *cs_port, uint16_t cs_pin)
{
    if (handle == 0 || spi_handle == 0) return W25Q_ERROR;
...
W25Q_Status_t W25Q_WaitForReady(W25Q_Handle_t *handle, uint32_t timeout_ms)
{
    ...
    while ((status & 0x01) != 0) {
        if ((osKernelSysTick() - start_tick) > ( ( TickType_t ) ( ( ( TickType_t ) ( timeout_ms ) * ( TickType_t ) ((TickType_t)1000) ) / ( TickType_t ) 1000 ) )) {
            W25Q_Deselect(handle);
            BSP_SPI_UnlockBus(handle->spi_bus);
            return W25Q_TIMEOUT;
        }
...
W25Q_Status_t W25Q_Write(W25Q_Handle_t *handle, uint32_t addr, uint8_t *buffer, uint32_t len)
{
    ...
    while (len > 0) {
        ...
        bytes_to_write = 256 - page_offset;
...
_Bool W25Q_IsBusy(W25Q_Handle_t *handle)
{
    ...
    if (BSP_SPI_LockBus(handle->spi_bus, handle->timeout) != BSP_SPI_OK) return 1;
