...
#line 26 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
#line 50 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
#line 131 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
#line 237 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
#line 325 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"

#line 347 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000004U:
       ...
       break;
#line 436 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
    case 0x00000007U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRH) |= ((GPIONumber & ((uint32_t)0x0000000B))));



       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRH) &= ~((GPIONumber & ((uint32_t)0x0000000B))));

       break;
#line 450 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
    default:
      status = HAL_ERROR;
      break;
  }
...
HAL_StatusTypeDef HAL_PWREx_DisableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000004U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRE) &= ~(GPIONumber));
       break;
#line 512 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
    case 0x00000007U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRH) &= ~((GPIONumber & ((uint32_t)0x0000000B))));
       break;
...
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000004U:
       ...
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRE) &= ~(GPIONumber));
       break;
#line 596 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
    case 0x00000007U:
       ...
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRH) &= ~((GPIONumber & ((uint32_t)0x0000000B))));
       break;
#line 610 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
    default:
      status = HAL_ERROR;
      break;
  }
...
HAL_StatusTypeDef HAL_PWREx_DisableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000004U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRE) &= ~(GPIONumber));
       break;
#line 672 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
    case 0x00000007U:
...
void HAL_PWREx_EnableSRAM2ContentRetention(void)
{
  (void) HAL_PWREx_SetSRAM2ContentRetention((0x1UL << (8U)));
}
...
void HAL_PWREx_DisableSRAM2ContentRetention(void)
{
  (void) HAL_PWREx_SetSRAM2ContentRetention(((uint32_t)0x00000000));
}
...
HAL_StatusTypeDef HAL_PWREx_SetSRAM2ContentRetention(uint32_t SRAM2Size)
{
  ...
  if (SRAM2Size == ((uint32_t)0x00000000))
  {
    ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) &= ~((0x1UL << (8U))));
  }
  else if (SRAM2Size == (0x1UL << (8U)))
  {
    (((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3)) = ((((((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3))) & (~((0x1UL << (8U))))) | ((0x1UL << (8U))))));
  }
#line 769 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
  else {
    return HAL_ERROR;
  }
...
#line 799 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"


#line 825 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"


#line 851 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"

#line 872 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"

#line 892 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"


#line 913 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_ConfigPVM(PWR_PVMTypeDef *sConfigPVM)
{
  ...
  {
#line 1013 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"

#line 1046 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
#line 1391 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
...
#line 1422 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"

#line 1435 "../Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_pwr_ex.c"
